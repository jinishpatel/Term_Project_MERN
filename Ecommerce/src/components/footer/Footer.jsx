			...
			<div className="footer-container">
				<div className="left-footer">
					...
					<div className="email">
						...
						<div>
							<p>
								<a href="mailto:lambton@gmail.com">lambton@gmail.com</a>
							</p>
						</div>
					</div>
				</div>
				<div className="right-footer">
					...
					<p>
						Thank you for choosing JPECOMMERCE for your online shopping
						needs. We strive to provide you with an exceptional shopping
						experience and top-quality products. Your satisfaction is our
						priority, and we are committed to delivering the best service
						possible. JPECOMMERCE - Your one-stop destination for all
						things fashionable, functional, and fabulous. Happy shopping!
					</p>
					<p className="social">
